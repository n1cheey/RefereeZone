...
Object.assign(translations.en, {
  ...
  'dashboard.statisticCrewLocked': 'Statistic crew can no longer be assigned after the match starts.',
  'dashboard.statisticCrewPastFillOnly': 'After the match starts, you can only fill empty statistic slots. Assigned statisticians are locked.',
  'dashboard.statisticCrewPastSelectAtLeastOne': 'Choose at least one statistician for an empty slot.',
...
Object.assign(translations.az, {
  ...
  'dashboard.statisticCrewLocked': 'Oyun başladıqdan sonra statistika heyəti artıq təyin edilə bilməz.',
  'dashboard.statisticCrewPastFillOnly': 'Oyun başladıqdan sonra yalnız boş statistika slotlarını doldurmaq olar. Təyin edilmiş statistiklər kilidlənir.',
  'dashboard.statisticCrewPastSelectAtLeastOne': 'Boş slot üçün ən azı bir statistik seçin.',
...
Object.assign(translations.ru, {
  ...
  'dashboard.statisticCrewLocked': 'После начала матча бригаду статистики назначать нельзя.',
  'dashboard.statisticCrewPastFillOnly': 'После начала матча можно заполнять только пустые слоты статистики. Уже назначенных статистиков менять нельзя.',
  'dashboard.statisticCrewPastSelectAtLeastOne': 'Выберите хотя бы одного статистика для пустого слота.',
